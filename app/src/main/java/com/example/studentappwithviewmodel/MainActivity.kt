package com.example.studentappwithviewmodel
...
import com.example.studentappwithviewmodel.ui.theme.StudentAppWithViewModelTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            StudentAppWithViewModelTheme {
